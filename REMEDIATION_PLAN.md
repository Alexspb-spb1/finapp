...
**Проект:** `Alexspb-spb1/finapp`  
**Исходная ветка аудита:** `claude/repository-analysis-mkk7mg`  
**Основание:** независимый аудит React / TypeScript / Firebase  
**Статус документа:** обязательный порядок исполнения  
...
- [ ] исходный commit зафиксирован;
- [ ] staging изолирован от production;
- [ ] резервная копия восстановлена и проверена;
- [ ] опубликованные Rules сохранены и оценены;
- [ ] есть baseline сборки и bundle;
- [ ] CI работает на PR.
