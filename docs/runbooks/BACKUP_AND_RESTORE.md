...
проект, однако, **ещё не создан** — попытка создания заблокирована на
этапе интерактивной авторизации (`BLOCKED_AUTHENTICATION`, подробности —
`docs/remediation/reports/BASE-003.md`, «Часть 2»). Раздел 5 ниже (два
варианта с рисками) оставлен как есть — Вариант B по-прежнему описан только
как формально допустимый запасной путь, не рекомендованный и не выбранный.
